...
public class DustScheduler {
	...
	@Autowired
	private DustAPIServiceImpl dustAPIService;
	
	@Scheduled(cron = "0 10 * * * *")	//매시간 10분에 동작 
	public void testSch() throws IOException {
		dustAPIService.selectAllScheduler();
		System.out.println("DUST 스케쥴러 작동! 수집 시간 : " + getDate());
	}
